...
model = CLIPVisionModelWithProjection.from_pretrained("openai/clip-vit-large-patch14-336").to(device)
...
print(f"CLIP large14-336 NightsPerceptualDataset accuracy projection = {100*correct/total:.3f}")