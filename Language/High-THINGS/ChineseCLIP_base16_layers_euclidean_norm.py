...
model = ChineseCLIPVisionModel.from_pretrained("OFA-Sys/chinese-clip-vit-base-patch16").to(device)
...
for k in range(len(correct)):
    print(f"ChineseCLIP base16 THINGS-odd-one-out accuracy layer {k} euclidean norm = {100*correct[k]/total:.3f}")
