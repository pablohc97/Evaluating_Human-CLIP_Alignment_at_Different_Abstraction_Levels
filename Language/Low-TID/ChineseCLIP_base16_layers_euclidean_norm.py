...
for i in range(len(features_img)):
    print(f'ChineseCLIP base16 TID-2013 spearman corr layer {i} euclidean norm = {-spearmanr(np.sqrt(distances_2013_clip_norm.mean(axis=2))[i],data_tid_2013.MOS)[0]:.3f}')
