...
model = SiglipModel.from_pretrained("google/siglip-base-patch16-224").to(device)     # if model = base -> layers = 13; if model = large -> layers = 25
...
print(f"SigLIP base16 THINGS-odd-one-out accuracy projection euclidean norm = {100*correct/total:.3f}")
